...
const integrationTestAlias = "ckalkan-integration-test"
...
func newIntegrationClient(t *testing.T, options ...ckalkan.Option) *ckalkan.Client {
	t.Helper()
