...
#define KC_CERTPROP_OCSP					0x0000081f
#define KC_CERTPROP_GET_CRL					0x00000820
#define KC_CERTPROP_GET_DELTA_CRL			0x00000821
//---------------------------------------------------------------------------------------
...
#define KC_HASH_GOST15_256			0x00100000
...
#define KCR_VERIFY_TS_HASH		KCR_BASE + 0x00000054
#define KCR_XADEST_FAILED		KCR_BASE + 0x00000055

#define KCR_OCSP_RESP_STAT_MALFORMEDREQUEST		KCR_BASE + 0x00000056
#define KCR_OCSP_RESP_STAT_INTERNALERROR		KCR_BASE + 0x00000057
#define KCR_OCSP_RESP_STAT_TRYLATER				KCR_BASE + 0x00000058
#define KCR_OCSP_RESP_STAT_SIGREQUIRED			KCR_BASE + 0x00000059
#define KCR_OCSP_RESP_STAT_UNAUTHORIZED			KCR_BASE + 0x0000005a
#define KCR_VERIFY_ISSUERSERIALV2				KCR_BASE + 0x0000005b
