...
// These benchmarks measure Go wrapper overhead using fake native calls. They
// do not measure SDK cryptography or SDK file I/O.
const (
...
func TestGoSideAllocsPerRun(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			maxAllocs: 3, // One allocation normalizes DER to the native PEM format.
			run: func() error {
